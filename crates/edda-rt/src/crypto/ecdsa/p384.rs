//! ECDSA over NIST P-384 (SHA-384, RFC 6979 deterministic).
...
const RAW_SIG_LEN: usize = 96;

/// P-384 ECDSA sign, DER output.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_sign_der(
...
/// P-384 ECDSA sign, raw r||s output.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_sign_raw(
    private_scalar: EdSlice,
    message: EdSlice,
...
/// P-384 ECDSA verify, DER signature.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_verify_der(
    public_key: EdSlice,
    message: EdSlice,
    signature: EdSlice,
) -> ResultBool {
...
/// P-384 ECDSA verify, raw r||s signature.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_verify_raw(
    public_key: EdSlice,
    message: EdSlice,
    signature: EdSlice,
) -> ResultBool {
...
/// P-384 point compression (97 → 49 bytes).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_point_compress(
...
/// P-384 point decompression (49 → 97 bytes).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p384_point_decompress(
    compressed: EdSlice,
