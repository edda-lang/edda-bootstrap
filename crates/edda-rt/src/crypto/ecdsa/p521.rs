//! ECDSA over NIST P-521 (SHA-512, RFC 6979 deterministic).
...
const RAW_SIG_LEN: usize = 132;

/// P-521 ECDSA sign, DER output.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_sign_der(
...
/// P-521 ECDSA sign, raw r||s output.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_sign_raw(
    private_scalar: EdSlice,
    message: EdSlice,
...
/// P-521 ECDSA verify, DER signature.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_verify_der(
    public_key: EdSlice,
    message: EdSlice,
    signature: EdSlice,
) -> ResultBool {
...
/// P-521 ECDSA verify, raw r||s signature.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_verify_raw(
    public_key: EdSlice,
    message: EdSlice,
    signature: EdSlice,
) -> ResultBool {
...
/// P-521 point compression (133 → 67 bytes).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_point_compress(
...
/// P-521 point decompression (67 → 133 bytes).
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __edda_ecdsa_p521_point_decompress(
    compressed: EdSlice,
